...
public class ArrayStack {
	...
	/**
	 * Method that inserts a new object in the ArrayStack if the ArrayStack is not full
	...
	public void push(Object data) {
		if(!isFull()) {
			...
			size++;
			stack[peak] = data;
		}else System.err.println("Error: cannot insert, the stack is full");
	}
	
	/**
	 * Method that extracts the peak element of the ArrayStack, removing it from the ArrayStack
